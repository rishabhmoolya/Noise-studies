...
fm=pd.DataFrame(fm)
fm.to_csv('T_bridge=15_14C_WW_pc.csv')
...
for i in range(100,900,100):
    ...
    with tb.open_file(f"/home/moolyari/Documents/Code/DATA/m611_labtest/T_bridge=15C/m611_{i}V_WW_14_noise_occupancy_scan_interpreted.h5", 'r') as infile:
    ...
    with tb.open_file(f"/home/moolyari/Documents/Code/DATA/m611_labtest/T_bridge=15C/m611_{i}V_WW_14C_stuck_pixel_scan_interpreted.h5", 'r') as infile:
    ...
    with tb.open_file(f"/home/moolyari/Documents/Code/DATA/m611_labtest/T_bridge=15C/m611_{i}V_WW_14C_noise_occupancy_scan_interpreted.h5", 'r') as infile:
