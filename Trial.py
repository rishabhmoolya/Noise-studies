...
for j in range(26, 19, -6):
    for i in range(300, 900, 100):
        ...
        for k in range(1,4,1):
            ...
            o_stuck = np.append(o_stuck,(d2-d1))
...
line1 = plt.plot(tp[0], v_np600[0], 'b--o', lw=1.5, label= '600 V @ T = -26°C')
line2 = plt.plot(tp[0], v_np600[1], 'b--o', lw=1.5)
line3 = plt.plot(tp[0], v_np600[2], 'b--o', lw=1.5)

line01 = plt.plot(tp[0], v_s600[0], 'b--*', lw=1.5, label= '600 V @ T = -26°C')
line02 = plt.plot(tp[0], v_s600[1], 'b--*', lw=1.5)
line03 = plt.plot(tp[0], v_s600[2], 'b--*', lw=1.5)

line4 = plt.plot(tp[1], v_np600[3], 'r--o', lw=1.5, label= '600 V @ T = -20°C')
line5 = plt.plot(tp[1], v_np600[4], 'r--o', lw=1.5)
line6 = plt.plot(tp[1], v_np600[5], 'r--o', lw=1.5)

line04 = plt.plot(tp[1], v_s600[3], 'r--*', lw=1.5, label= '600 V @ T = -20°C')
line05 = plt.plot(tp[1], v_s600[4], 'r--*', lw=1.5)
line06 = plt.plot(tp[1], v_s600[5], 'r--*', lw=1.5)
...
line16 = plt.plot(tp[1], v_np800[3], 'g--o', lw=1.5, label= '800 V @ T = -20°C')
line17 = plt.plot(tp[1], v_np800[4], 'g--o', lw=1.5)
line18= plt.plot(tp[1], v_np800[5], 'g--o', lw=1.5)
